...
public class Building 
{
    ...
    public Building(String fileName, float width, float height, float depth)
    {
        ...
        building = new Mesh(Arrays.asList(new Triangle[]{
        //SOUTH
        ...
        building.transform.setRotAngleY(degToRad(90));
        
        for(Triangle t: building.triangles)
        {
