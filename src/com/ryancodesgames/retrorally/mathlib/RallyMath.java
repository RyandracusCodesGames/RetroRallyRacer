    ...
    */
    ...
    -0.1564f,-0.1392f,-0.1219f,-0.1045f,-0.0872f,-0.0698f,-0.0523f,-0.0349f,-0.0175f,-0.0000f,0.0175f,0.0349f,0.0523f,0.0698f,0.0872f,0.1045f,0.1219f,0.1392f,0.1564f,0.1736f,
     ...
     /**
      ...
      with each index of the array representing a degree value.
    */
    public static float[] tan = new float[]
    ...
    -0.3443f,-0.3249f,-0.3057f,-0.2867f,-0.2679f,-0.2493f,-0.2309f,-0.2126f,-0.1944f,-0.1763f,-0.1584f,-0.1405f,-0.1228f,-0.1051f,-0.0875f,-0.0699f,-0.0524f,-0.0349f,-0.0175f,-0.0000f
      ...
      * Converts from degrees to radians
      @param angle Input degree value
      @return The radian equivalent to the input angle.
    */
    public static float degToRad(float angle)
    {
        return (angle * (PI / 180.00f));
    }
    /*
     * Converts from radians to degrees
      @param rad Input radian value
      @return The degree equivalent to the input radian value.
    */
    ...
    public static float clamp(float targetVal, float min, float max)
    {
        return min(max(targetVal,min),max);
    }
    ...
    public static float sqrt(float a)
    {
        ...
        /*Find the surrounding perfect square as an intial approximation*/
        p = 0;
        do
        {
            p++;
    ...
    public static float inverse_lerp(float a, float b, float t)
    {
        return (t - a) / (b - a);
    }
    
    public static float turnTowards(Vec3D pos, Vec3D target, float angleOffSet)
    {
        Vec3D vectorToTarget = pos.vec3f_sub(target, pos);
        return (float)Math.atan2(vectorToTarget.z, vectorToTarget.x) + degToRad(angleOffSet);
    }
}
